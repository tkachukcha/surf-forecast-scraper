...
async function getData([spotName, region, windUrl, mswUrl, sfUrl]) {
  try {
...
const spots = [
  ...
  ['Alanya', 'Turkey (Mediterranian)', 'https://www.windguru.cz/37745', 'https://magicseaweed.com/Alanya-Surf-Report/4456/', '']
];
